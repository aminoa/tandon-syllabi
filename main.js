...
var CS_SYLLABI = { //list of all CS syllabi
    ...
    "3083": "Introduction to Parallel and Distributed Systems",
...
function load()
{
    for (let classCode in CS_SYLLABI) {
        document.getElementById("links").innerHTML += ("<h3><a href=../syllabi/CS-UY/" + classCode + ".pdf>" + CS_SYLLABI[classCode] + "</a></h3>");
    }    
}
